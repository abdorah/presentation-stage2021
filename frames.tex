...
\begin{figure}[ht!]
  ...
  \begin{subfigure}[b]{0.3\textwidth}
    \frame{\includegraphics[width=\textwidth]{screenshots/mainicon.png}}
...
\begin{frame}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{figure}
      \includegraphics[width=0.6\textwidth]{screenshots/logo-uir2.jpg}
    \end{figure}
...
\begin{frame}{\insertsectionhead}
  ...
  \begin{columns}[T,onlytextwidth]
    ...
    \begin{figure}
      \includegraphics[width=0.6\textwidth]{screenshots/dynit.png}
    \end{figure}
    \column{0.30\textwidth}
    Client: \textbf{\textsc{DGCT}}
    \begin{figure}
      \includegraphics[width=0.8\textwidth]{screenshots/logo-fr.png}
    \end{figure}
